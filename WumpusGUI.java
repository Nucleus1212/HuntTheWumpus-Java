...
public class WumpusGUI extends javax.swing.JFrame {
	private final static String fileName = "caves1.txt";
	...
	private void moveButtonMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_moveButtonMouseClicked
		if (this.player.isAlive() && this.maze.stillWumpi()) {
	...
	private void startGame() {
		try {
			...
			this.outputArea.setText("Your mission is to explore the maze of caves and\n"
					...
					+ "You are searching for " + this.maze.getNumWumpi() + " " + oneOrMore + ".");
			this.update();

...
public class WumpusTerminal {
	public static void main(String[] args) throws FileNotFoundException {
		CaveMaze maze = new CaveMaze("caves1.txt");
		...
		String oneOrMore = "wumpus";
		if (maze.getNumWumpi() > 1) {
			oneOrMore = "wumpi";
		}
		System.out.println("\nYou are searching for " + maze.getNumWumpi() + " " + oneOrMore + ".");

		Scanner input = new Scanner(System.in);
		while (player.isAlive() && maze.stillWumpi()) {
			System.out.println("\n" + maze.showLocation());
